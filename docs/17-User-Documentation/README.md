...
No end-user features are shipped yet (Phase 01 delivered the platform foundation + a login
shell). The interim getting-started path is the local-dev quickstart in the root
[README](../../README.md). User guides will be added as features become usable, closed out
per **CLAUDE.md §11**.
